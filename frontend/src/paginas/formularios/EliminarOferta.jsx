...
import { eliminar_oferta } from "../../api/api_ofertas";

import { useState } from "react";

export default function EliminarOferta({ show, setShow, refresh, seleccionado }) {
    ...
    const eliminar = async () => {
        ...
        try {
            await eliminar_oferta(seleccionado._id);
