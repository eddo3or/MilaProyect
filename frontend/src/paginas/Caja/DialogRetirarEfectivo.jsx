...
export default function DialogRetirarEfectivo({ refresh }) {
    ...
    const handleSubmit = () => {
        const peticion = async () => {
            setLoading(true);
            return axios.put("/cajas/retirar-efectivo/67e4f06c9dcadc442adc8a7f", { dinero }).then(() => {
        ...
        toaster.promise(peticion, {
            ...
            error: (result) => {
                ...
                return {
                    title: "ERROR!",
                    description: result.response?.data?.message || "Hubo un error retirando dinero de la caja"
                }
            },
    ...
    return (
        ...
        >
            <Dialog.Trigger asChild>
                <Button colorPalette="red" size="2xl">
